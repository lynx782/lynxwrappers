...
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://124557134667231", BackgroundTransparency = 0 },
...
Tab1:AddDiscordInvite({
    Name = "lcc hub",
    Description = "https://discord.gg/3Ze2FQDEV",
    Logo = "rbxassetid://124557134667231",
    Invite = "https://discord.gg/3Ze2FQDEV",
})
...
local Paragraph = Tab1:AddParagraph({"Criadores", "lcc"})

Tab1:AddButton({
    Name = " - Copiar @ do TikTok",
    Callback = function()
      setclipboard("@lcchub0")
      setclipboard("https://www.tiktok.com/@lcchub0?_r=1&_t=ZS-916Of50jpCf")
    end
})
